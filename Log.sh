...
#The actual log files are stored at ${BUILD_HOME}/runtime/<cloudhost>/<build_identifier>/logs

#${BUILD_HOME}/helpers/DisplayLoggingStreams.sh vultr crew ${1} ${2} 

${BUILD_HOME}/helpers/DisplayLoggingStreams.sh linode crew ${1} ${2} 
#${BUILD_HOME}/helpers/DisplayLoggingStreams.sh digitalocean crew2 ${1} ${2}

#Defaults to interactive
if ( [ "$?" != "0" ] )
then
	${BUILD_HOME}/helpers/DisplayLoggingStreams.sh
fi
