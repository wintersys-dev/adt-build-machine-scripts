...
SYSTEM_EMAIL_USERNAME="`${BUILD_HOME}/helpers/GetVariableValue.sh SYSTEM_EMAIL_USERNAME`"
SYSTEM_EMAIL_PASSWORD="`${BUILD_HOME}/helpers/GetVariableValue.sh SYSTEM_EMAIL_PASSWORD`"
SYSTEM_EMAIL_PROVIDER="`${BUILD_HOME}/helpers/GetVariableValue.sh SYSTEM_EMAIL_PROVIDER`"
SYSTEM_TOEMAIL_ADDRESS="`${BUILD_HOME}/helpers/GetVariableValue.sh SYSTEM_TOEMAIL_ADDRESS`"
SYSTEM_FROMEMAIL_ADDRESS="`${BUILD_HOME}/helpers/GetVariableValue.sh SYSTEM_FROMEMAIL_ADDRESS`"

update="0"

if ( ( [ "${SYSTEM_EMAIL_USERNAME}" = "" ] || [ "${SYSTEM_EMAIL_PASSWORD}" = "" ] || [ "${SYSTEM_EMAIL_PROVIDER}" = "" ] || [ "${SYSTEM_TOEMAIL_ADDRESS}" = "" ] || [ "${SYSTEM_FROMEMAIL_ADDRESS}" = "" ] ) && [ "`${BUILD_HOME}/helpers/IsHardcoreBuild.sh`" != "1" ] )
then
	status ""
	status ""
	status "#############################################################################################################################################"
...
if ( [ "${update}" = "1" ] && [ "`${BUILD_HOME}/helpers/IsHardcoreBuild.sh`" != "1" ] )
then
	...
	${BUILD_HOME}/helpers/SetVariableValue.sh "SYSTEM_EMAIL_USERNAME=${SYSTEM_EMAIL_USERNAME}"
	${BUILD_HOME}/helpers/SetVariableValue.sh "SYSTEM_EMAIL_PASSWORD=${SYSTEM_EMAIL_PASSWORD}"
	${BUILD_HOME}/helpers/SetVariableValue.sh "SYSTEM_EMAIL_PROVIDER=${SYSTEM_EMAIL_PROVIDER}"
	${BUILD_HOME}/helpers/SetVariableValue.sh "SYSTEM_TOEMAIL_ADDRESS=${SYSTEM_TOEMAIL_ADDRESS}"
	${BUILD_HOME}/helpers/SetVariableValue.sh "SYSTEM_FROMEMAIL_ADDRESS=${SYSTEM_FROMEMAIL_ADDRESS}"
