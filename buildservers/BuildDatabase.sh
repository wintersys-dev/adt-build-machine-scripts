...
DB_SERVER_TYPE="`${BUILD_HOME}/helpers/services/GetVariableValue.sh DB_SERVER_TYPE`"
...
do
	...
	then
		...
		then
			${BUILD_HOME}/helpers/services/SetVariableValue.sh "DB_IDENTIFIER=${DBIP_PRIVATE}"
		fi
