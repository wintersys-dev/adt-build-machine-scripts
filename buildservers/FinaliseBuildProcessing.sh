...
IN_PARALLEL="`${BUILD_HOME}/helpers/services/GetVariableValue.sh IN_PARALLEL`"
...
then    
	...
	status "The build will pause here until you have interactively completed the installation using your browser at ${WEBSITE_URL} and the below credentials"
