...
if ( [ "${DATASTORE_PROVIDER}" != "`/bin/cat ${BUILD_HOME}/runtime/ACTIVE_CLOUDHOST`" ] )
then
	...
	then
		/bin/echo "${DATASTORE_PROVIDER}" > ${BUILD_HOME}/runtime/ACTIVE_CLOUDHOST
	fi
fi

if ( [ ! -d ${BUILD_HOME}/runtime/${DATASTORE_PROVIDER}/${BUILD_IDENTIFIER}/ips ] )
then
	/bin/mkdir -p ${BUILD_HOME}/runtime/${DATASTORE_PROVIDER}/${BUILD_IDENTIFIER}/ips
fi
...
${BUILD_HOME}/services/datastore/operations/GetFromDatastore.sh "auth" "authorised-ips.dat" "${BUILD_HOME}/runtime/${DATASTORE_PROVIDER}/${BUILD_IDENTIFIER}/ips" "${IDENTIFIER}"

if ( [ ! -f ${BUILD_HOME}/runtime/${DATASTORE_PROVIDER}/${BUILD_IDENTIFIER}/ips/authorised-ips.dat ] )
then
	/bin/echo "Couldn't find existing authorised ip addresses"
	${BUILD_HOME}/services/datastore/operations/MountDatastore.sh "auth" "local" "${IDENTIFIER}"
fi

if ( [ "${mode}" = "1" ] )
then
	/bin/echo ${ip} >> ${BUILD_HOME}/runtime/${DATASTORE_PROVIDER}/${BUILD_IDENTIFIER}/ips/authorised-ips.dat
else
	/bin/sed -i "/${ip}/d" ${BUILD_HOME}/runtime/${DATASTORE_PROVIDER}/${BUILD_IDENTIFIER}/ips/authorised-ips.dat
fi

/bin/cat ${BUILD_HOME}/runtime/${DATASTORE_PROVIDER}/${BUILD_IDENTIFIER}/ips/authorised-ips.dat | /usr/bin/sort | /usr/bin/uniq >> ${BUILD_HOME}/runtime/${DATASTORE_PROVIDER}/${BUILD_IDENTIFIER}/ips/authorised-ips.dat.$$
/bin/mv ${BUILD_HOME}/runtime/${DATASTORE_PROVIDER}/${BUILD_IDENTIFIER}/ips/authorised-ips.dat.$$ ${BUILD_HOME}/runtime/${DATASTORE_PROVIDER}/${BUILD_IDENTIFIER}/ips/authorised-ips.dat
${BUILD_HOME}/services/datastore/operations/PutToDatastore.sh "auth" "${BUILD_HOME}/runtime/${DATASTORE_PROVIDER}/${BUILD_IDENTIFIER}/ips/authorised-ips.dat" "root" "local" "no" "${IDENTIFIER}"
/bin/touch  ${BUILD_HOME}/runtime/${DATASTORE_PROVIDER}/${BUILD_IDENTIFIER}/FIREWALL-EVENT
${BUILD_HOME}/services/datastore/operations/PutToDatastore.sh "auth" "${BUILD_HOME}/runtime/${DATASTORE_PROVIDER}/${BUILD_IDENTIFIER}/FIREWALL-EVENT" "root" "local" "no" "${IDENTIFIER}"
/bin/rm ${BUILD_HOME}/runtime/${DATASTORE_PROVIDER}/${BUILD_IDENTIFIER}/FIREWALL-EVENT
