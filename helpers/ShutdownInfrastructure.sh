...
then
	/bin/echo "This script is expected to run from the helpers directory"
	exit
fi
...
autoscaler_token_to_match="as-`${BUILD_HOME}/helpers/GetVariableValue.sh REGION`-${BUILD_IDENTIFIER}"
webserver_token_to_match="ws-`${BUILD_HOME}/helpers/GetVariableValue.sh REGION`-${BUILD_IDENTIFIER}"
database_token_to_match="db-`${BUILD_HOME}/helpers/GetVariableValue.sh REGION`-${BUILD_IDENTIFIER}"
