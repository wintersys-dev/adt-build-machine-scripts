...
/bin/echo "USERNAME:${SERVER_USER}" > ${BUILD_HOME}/runtime/wholemachinesnapshots/${WEBSITE_URL}/snapshots/credentials.dat
/bin/echo "PASSWORD:${SERVER_USER_PASSWORD}" >> ${BUILD_HOME}/runtime/wholemachinesnapshots/${WEBSITE_URL}/snapshots/credentials.dat
...
if ( [ -f ${BUILD_HOME}/runtime/wholemachinesnapshots/${WEBSITE_URL}/snapshots/db_credentials.dat.candidate ] )
then
	/bin/cp ${BUILD_HOME}/runtime/wholemachinesnapshots/${WEBSITE_URL}/snapshots/db_credentials.dat.candidate ${BUILD_HOME}/runtime/wholemachinesnapshots/${WEBSITE_URL}/snapshots/db_credentials.dat
fi

machine_id="`${BUILD_HOME}/services/server/ListServerIDs.sh "${machine_type}-${REGION}-${BUILD_IDENTIFIER}" ${CLOUDHOST} | /usr/bin/head -n 1`"
...
then
	...
	/bin/echo "Trying to update stored snapshot ids located at: ${BUILD_HOME}/runtime/wholemachinesnapshots/${WEBSITE_URL}/snapshots/snapshot_ids.dat"

	if ( [ -f ${BUILD_HOME}/runtime/wholemachinesnapshots/${WEBSITE_URL}/snapshots/snapshot_ids.dat ] )
	then
		if ( [ "`/bin/grep ${machine_label} ${BUILD_HOME}/runtime/wholemachinesnapshots/${WEBSITE_URL}/snapshots/snapshot_ids.dat`" != "" ] )
		then
			/bin/sed -i "s/.*${machine_label}.*/${machine_label}:${snapshot_id}/" ${BUILD_HOME}/runtime/wholemachinesnapshots/${WEBSITE_URL}/snapshots/snapshot_ids.dat
		else
			/bin/echo "${machine_label}:${snapshot_id}" >> ${BUILD_HOME}/runtime/wholemachinesnapshots/${WEBSITE_URL}/snapshots/snapshot_ids.dat
		fi
...
then
	region_id="`/bin/cat ${BUILD_HOME}/runtime/${CLOUDHOST}/${BUILD_IDENTIFIER}/CURRENTREGION`"
...
${BUILD_HOME}/services/datastore/operations/MountDatastore.sh "snap" "local"
${BUILD_HOME}/services/datastore/operations/PutToDatastore.sh "snap" "${BUILD_HOME}/runtime/wholemachinesnapshots/${WEBSITE_URL}/snapshots/snapshot_ids.dat" "root" "local" "no"
${BUILD_HOME}/services/datastore/operations/PutToDatastore.sh "snap" "${BUILD_HOME}/runtime/wholemachinesnapshots/${WEBSITE_URL}/snapshots/db_credentials.dat.candidate" "root" "local" "no"
${BUILD_HOME}/services/datastore/operations/PutToDatastore.sh "snap" "${BUILD_HOME}/runtime/wholemachinesnapshots/${WEBSITE_URL}/snapshots/db_credentials.dat" "root" "local" "no"
${BUILD_HOME}/services/datastore/operations/PutToDatastore.sh "snap" "${BUILD_HOME}/runtime/wholemachinesnapshots/${WEBSITE_URL}/snapshots/credentials.dat" "root" "local" "no"

cwd="`/usr/bin/pwd`"
cd ${BUILD_HOME}/runtime/${CLOUDHOST}/test-build/keys
/bin/tar cvfz keys.tar.gz *BUILD_KEY*
cd ${cwd}

${BUILD_HOME}/services/datastore/operations/PutToDatastore.sh  ${BUILD_HOME}/runtime/${CLOUDHOST}/${BUILD_IDENTIFIER}/keys/keys.tar.gz ${snap_bucket}
