...
# Author: Peter Winter
# Date  : 13/07/2016
# Description : This script will connect you to your authenticator via ssh and run the command passed as a parameter
######################################################################################################################################################
# License Agreement:
...
/bin/echo "Which authenticator would you like to execute a command on?"
count=1
for ip in ${ips}
do
        /bin/echo "${count}:   ${ip}"
