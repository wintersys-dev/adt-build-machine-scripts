...
This can be set to one of "none", "joomla", "wordpress", "drupal", "moodle", "ossn", "social-messenger"
...
Please review [chaining keys](https://www.wintersys-dev.uk/Agile%20Deployment%20Toolkit/Deployment/AdvancedDatastoreConfiguration/)
...
If you are unsure how to find your account ID and how to generate your API token with DNS Edit scope you can look [here](https://www.wintersys-dev.uk/Agile%20Deployment%20Toolkit/Deployment/CloudflareAPITokens)
...
For more information on finding the correct VPC_IP_RANGE for your current deployment please refer to [this](https://www.wintersys-dev.uk/Agile%20Deployment%20Toolkit/Deployment/VpcIPRanges/)
...
The number of authenticators you want to deploy up to a maximumm of 3 authenticators. 
...
INFRASTRUCTURE_REPOSITORY_OWNER="wintersys-dev"  

INFRASTRUCTURE_REPOSITORY_USERNAME="wintersys-dev"  
...
Please review [this](https://github.com/wintersys-dev/adt-build-machine-scripts/blob/master/doco/AgileToolkitDeployment/DeployingDBaaS.md) for how to set the shortcut values for your DBaaS provider.
...
1. LETSENCRYPT (letsencrypt certificates can only be issued when **lego** is the SSLCERTCLIENT in software.dat on the build machine)
2. ZEROSSL     (zerossl certificates can only be issued when **acme** is the SSLCERTCLIENT in software.dat on the build machine)
