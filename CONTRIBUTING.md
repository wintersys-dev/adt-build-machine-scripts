...
The relevant files are: [Apache](https://github.com/wintersys-dev/adt-webserver-scripts/blob/master/services/webserver/configuration/InstallApache.sh) [Nginx](https://github.com/wintersys-dev/adt-webserver-scripts/blob/master/services/webserver/configuration/InstallNginx.sh) [Lighttpd](https://github.com/wintersys-dev/adt-webserver-scripts/blob/master/services/webserver/configuration/InstallLighttpd.sh)
