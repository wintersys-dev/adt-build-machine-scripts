...
export BUILD_MACHINE_IP="`${BUILD_HOME}/helpers/services/GetBuildMachineIP.sh`"
...
SERVER_USER_PASSWORD="`${BUILD_HOME}/helpers/services/GetVariableValue.sh SERVER_USER_PASSWORD`"
