...
4. /bin/sh ./helpers/GenerateOverrideTemplate.sh and answer the questions as it asks them

5. /bin/sh ./helpers/GenerateHardcoreUserDataScript.sh and answer the questions as it asks them
