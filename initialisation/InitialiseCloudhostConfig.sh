...
CLOUDHOST_ACCOUNT_ID="`${BUILD_HOME}/helpers/services/GetVariableValue.sh CLOUDHOST_ACCOUNT_ID`"
REGION="`${BUILD_HOME}/helpers/services/GetVariableValue.sh REGION`"
ACCESS_KEY="`${BUILD_HOME}/helpers/services/GetVariableValue.sh ACCESS_KEY`"
SECRET_KEY="`${BUILD_HOME}/helpers/services/GetVariableValue.sh SECRET_KEY`"
...
then
	...
	if ( [ "`${BUILD_HOME}/helpers/services/IsHardcoreBuild.sh`" = "0" ] )
	then
