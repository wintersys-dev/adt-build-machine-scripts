...
WEBMASTER_EMAIL="`${BUILD_HOME}/helpers/GetVariableValue.sh 'SYSTEM_TOEMAIL_ADDRESS'`"
...
SYSTEM_TOEMAIL_ADDRESS="`${BUILD_HOME}/helpers/GetVariableValue.sh 'SYSTEM_TOEMAIL_ADDRESS' | /bin/sed 's/_/ /g'`"
WEBSITE_DISPLAY_NAME="`${BUILD_HOME}/helpers/GetVariableValue.sh 'WEBSITE_DISPLAY_NAME'` Webmaster"
...
/bin/sed -i "s/XXXXSMTP_USERXXXX/${SYSTEM_EMAIL_USERNAME}/" ${BUILD_HOME}/runtime/${CLOUDHOST}/${BUILD_IDENTIFIER}/application/${APPLICATION}.dat
/bin/sed -i "s/XXXXSMTP_PASSXXXX/${SYSTEM_EMAIL_PASSWORD}/" ${BUILD_HOME}/runtime/${CLOUDHOST}/${BUILD_IDENTIFIER}/application/${APPLICATION}.dat
/bin/sed -i "s/XXXXSMTP_SECUREXXXX/tls/" ${BUILD_HOME}/runtime/${CLOUDHOST}/${BUILD_IDENTIFIER}/application/${APPLICATION}.dat
