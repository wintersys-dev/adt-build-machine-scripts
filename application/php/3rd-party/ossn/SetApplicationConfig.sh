...
# settings necessary for the ossn application to be brought online
# Date: 07/11/2024
# Author: Peter Winter
####################################################################################
# License Agreement:
...
/bin/cp ${BUILD_HOME}/application/php/3rd-party/${APPLICATION}/descriptor.dat ${BUILD_HOME}/runtime/${CLOUDHOST}/${BUILD_IDENTIFIER}/application/${APPLICATION}.dat
