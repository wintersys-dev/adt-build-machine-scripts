...
then
	...
	${BUILD_HOME}/helpers/SetVariableValue.sh "ENABLE_DDOS_PROTECION=${ENABLE_DDOS_PROTECION}"
fi
...
then
	PRODUCTION="0"
	DEVELOPMENT="1"
	${BUILD_HOME}/helpers/SetVariableValue.sh "PRODUCTION=${PRODUCTION}"
	${BUILD_HOME}/helpers/SetVariableValue.sh "DEVELOPMENT=${DEVELOPMENT}"
fi
